...
{	
	...
	{
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(ModBlocks.TFCBeacon, 1), "2 4", "535", "111", '1', "blockPlatinum", '2', "craftingToolHardChisel", '3', "itemNetherStar", '4', "craftingToolHardHammer", '5', "blockGlass"));
	}
